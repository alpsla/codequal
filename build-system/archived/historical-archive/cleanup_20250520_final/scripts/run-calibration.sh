...
node ./packages/core/scripts/calibration/run-calibration.js

# Check if the script succeeded
if [ $? -eq 0 ]; then
  echo "Calibration process has completed successfully"
  echo "The optimal model configurations have been updated in the database"
else
