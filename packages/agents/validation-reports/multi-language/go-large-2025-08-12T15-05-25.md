...
1. **Performance bottleneck detected in Go implementation** - src/core.go:250:10
2. **High coupling detected between modules** - src/architecture/design.md:1:45
...
1. **[PR-HIGH-1]** Potential security vulnerability in Go code - src/main.go:100:18
