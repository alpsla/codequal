...
1. **Code complexity exceeds threshold in Elixir module**
   - Location: src/utils.elixir:50:66
...
1. **Code complexity exceeds threshold in Elixir module** - src/utils.elixir:50:63
...
**Current Skill Score: 48.5/100 (F)**
- Previous Score: 50/100 (New User Base)
- Score Change: -1.5 points
- Trend: ↓
