...
1. **Code complexity exceeds threshold in Python module**
   - Location: src/quality0.python:100:70
...
1. **medium severity new issue 1** - src/file0.ts:10:6
2. **medium severity new issue 2** - src/file1.ts:20:2
3. **Code complexity exceeds threshold in Python module** - src/quality0.python:100:27

### 🟢 Low Issues (4)

1. **low severity new issue 1** - src/file0.ts:10:55
2. **low severity new issue 2** - src/file1.ts:20:14
3. **low severity new issue 3** - src/file2.ts:30:53
4. **low severity new issue 4** - src/file3.ts:40:35
