...
**Analysis Date:** 2025-08-12T15:31:04.382Z  
...
2. **medium severity new issue 3**
   **File:** src/file2.ts:30:13
   **Impact:** Potential security vulnerability
   **Fix:** Should be addressed

#### LOW (3)
1. **low severity new issue 1**
   **File:** src/file0.ts:10:33
...
1. **Code complexity exceeds threshold in TypeScript module**
   - Location: src/quality0.typescript:100:41
   - Fix: Refactor to improve code quality

#### LOW (1)
1. **Code complexity exceeds threshold in TypeScript module**
   - Location: src/quality1.typescript:110:27
...
1. **medium severity new issue 1** - src/file0.ts:10:2
2. **medium severity new issue 2** - src/file1.ts:20:72
3. **medium severity new issue 3** - src/file2.ts:30:71
4. **Code complexity exceeds threshold in TypeScript module** - src/quality0.typescript:100:69

### 🟢 Low Issues (6)

1. **low severity new issue 1** - src/file0.ts:10:6
2. **low severity new issue 2** - src/file1.ts:20:3
3. **low severity new issue 3** - src/file2.ts:30:40
4. **low severity new issue 4** - src/file3.ts:40:26
5. **low severity new issue 5** - src/file4.ts:50:56
6. **Code complexity exceeds threshold in TypeScript module** - src/quality1.typescript:110:67
