...
**Analysis Date:** 2025-08-12T15:31:04.387Z  
...
1. **medium severity new issue 1** - src/file0.ts:10:54
2. **Code complexity exceeds threshold in Go module** - src/quality0.go:100:31

### 🟢 Low Issues (4)

1. **low severity new issue 1** - src/file0.ts:10:67
2. **low severity new issue 2** - src/file1.ts:20:10
3. **Code complexity exceeds threshold in Go module** - src/quality1.go:110:8
4. **Code complexity exceeds threshold in Go module** - src/quality2.go:120:62
