...
1. **medium severity new issue 1** - src/file0.ts:10:1
2. **Code complexity exceeds threshold in Go module** - src/quality0.go:100:28

### 🟢 Low Issues (4)

1. **low severity new issue 1** - src/file0.ts:10:2
2. **low severity new issue 2** - src/file1.ts:20:48
3. **Code complexity exceeds threshold in Go module** - src/quality1.go:110:64
4. **Code complexity exceeds threshold in Go module** - src/quality2.go:120:16
