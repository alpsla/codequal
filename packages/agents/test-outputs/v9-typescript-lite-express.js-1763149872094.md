...
**Pull Request:** #5000 - PR #5000  
**Author:** test-user (test@example.com)  
**Organization:** expressjs  
**Source Branch:** pr-5000  
**Target Branch:** main  
**Analysis Date:** November 14, 2025 at 02:51 PM EST  
...
|------|-----------|-------|-------------|
| 1 | dependabot[bot] | 50/100 | 9 |
| 2 | Phillip Barta | 50/100 | 1 |
| 3 | **test-user** | **50/100** | **1** |
