...
exports.TOOL_LANGUAGES = exports.LANGUAGE_FIXERS = exports.TIER2_FIXERS = exports.TIER1_FIXERS = void 0;
exports.routeToFixer = routeToFixer;
exports.routeAndGroupIssues = routeAndGroupIssues;
exports.getRouteSummary = getRouteSummary;
exports.canFixerHandleRule = canFixerHandleRule;
exports.getFixersForLanguage = getFixersForLanguage;
exports.getFixerConfig = getFixerConfig;
const issue_classifier_1 = require("./issue-classifier");
...
exports.TIER1_FIXERS = TIER1_FIXERS;
...
exports.TIER2_FIXERS = TIER2_FIXERS;
// Language-specific fixer preferences
const LANGUAGE_FIXERS = {
    'javascript': {
...
exports.LANGUAGE_FIXERS = LANGUAGE_FIXERS;
...
exports.TOOL_LANGUAGES = TOOL_LANGUAGES;
/**
 * Get the appropriate fixer for a tool and issue type
 */
function getFixerForTool(tool, issueType, fixable) {
    ...
    if (language === 'java') {
        if (issueType === 'quality' || issueType === 'performance')
            return 'sorald';
        if (issueType === 'compatibility')
            return 'openrewrite';
    }
 ...
 */
function routeToFixer(issue) {
    // First classify the issue
    const classification = (0, issue_classifier_1.classifyIssue)(issue.ruleId, issue.tool);
 ...
 */
function routeAndGroupIssues(issues) {
 ...
 */
function getRouteSummary(issues) {
    const summary = {
        total: issues.length,
        byTier: { 1: 0, 2: 0, 3: 0 },
        byFixer: {},
 ...
 */
function canFixerHandleRule(fixer, ruleId) {
    const tier2Fixer = TIER2_FIXERS[fixer];
    if (tier2Fixer === null || tier2Fixer === void 0 ? void 0 : tier2Fixer.supportedRules) {
