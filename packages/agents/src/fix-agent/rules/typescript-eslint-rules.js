...
exports.ALL_TYPESCRIPT_ESLINT_RULES = exports.TS_ADDITIONAL_RULES = exports.TS_STYLISTIC_TYPE_CHECKED_RULES = exports.TS_STYLISTIC_RULES = exports.TS_STRICT_TYPE_CHECKED_RULES = exports.TS_STRICT_RULES = exports.TS_TYPE_CHECKED_RULES = exports.TS_RECOMMENDED_RULES = void 0;
exports.getTypeScriptESLintRuleStats = getTypeScriptESLintRuleStats;
exports.getBaseRule = getBaseRule;
// =============================================================================
// RECOMMENDED RULES - Core correctness rules
// =============================================================================
exports.TS_RECOMMENDED_RULES = {
...
// =============================================================================
exports.TS_STRICT_TYPE_CHECKED_RULES = {
...
// =============================================================================
exports.TS_STYLISTIC_TYPE_CHECKED_RULES = {
...
// =============================================================================
exports.ALL_TYPESCRIPT_ESLINT_RULES = {};
...
for (const ruleSet of allRuleSets) {
    for (const [rule, definition] of Object.entries(ruleSet)) {
        exports.ALL_TYPESCRIPT_ESLINT_RULES[`@typescript-eslint/${rule}`] = definition;
    }
}
/**
 * Get statistics about TypeScript-ESLint rule coverage
 */
function getTypeScriptESLintRuleStats() {
    const stats = {
        total: 0,
        fixable: 0,
        requiresTypeInfo: 0,
    ...
    for (const rule of Object.values(exports.ALL_TYPESCRIPT_ESLINT_RULES)) {
        stats.total++;
        if (rule.fixable)
            stats.fixable++;
        if (rule.requiresTypeInfo)
            stats.requiresTypeInfo++;
        if (rule.extendsBase)
            stats.extendsBase++;
 ...
 */
function getBaseRule(tsRule) {
    const rule = exports.ALL_TYPESCRIPT_ESLINT_RULES[tsRule];
    return rule === null || rule === void 0 ? void 0 : rule.extendsBase;
}
