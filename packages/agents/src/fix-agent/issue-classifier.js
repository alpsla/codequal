...
exports.CHECKSTYLE_RULES = exports.PMD_RULES = exports.SEMGREP_RULES = exports.RUFF_RULES = exports.ESLINT_RULES = void 0;
...
exports.ESLINT_RULES = ESLINT_RULES;
...
exports.SEMGREP_RULES = SEMGREP_RULES;
...
exports.CHECKSTYLE_RULES = CHECKSTYLE_RULES;
 ...
 */
function classifyIssue(ruleId, tool) {
    ...
    if (normalizedTool === 'eslint' || normalizedTool.includes('eslint')) {
        const comprehensiveMatch = (0, rules_1.lookupESLintRule)(ruleId);
 ...
 */
function determineFixTier(issueType, fixable, tool) {
...
function getClassificationStats() {
    ...
    const comprehensiveStats = (0, rules_1.getRuleCoverageStats)();
