...
exports.containsAIErrorPatterns = containsAIErrorPatterns;
exports.cleanAIContent = cleanAIContent;
exports.getCategoryFromTool = getCategoryFromTool;
exports.formatRuleTitle = formatRuleTitle;
exports.getLanguageFromFile = getLanguageFromFile;
exports.getUserFriendlyTitle = getUserFriendlyTitle;
/**
 ...
 */
function containsAIErrorPatterns(content) {
    if (!content)
        return false;
 ...
 */
function stripLicenseHeaders(code) {
    if (!code)
        return '';
 ...
 */
function getCategoryFromTool(tool) {
    if (tool === 'semgrep')
        return 'Security';
 ...
 */
function getUserFriendlyTitle(rule, tool) {
