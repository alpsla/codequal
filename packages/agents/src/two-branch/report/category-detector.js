...
exports.getCategoryContext = getCategoryContext;
exports.getPriorityGuidance = getPriorityGuidance;
/**
 ...
 */
function detectCategory(rule, tool, message) {
    // CRITICAL: Handle null/undefined rule to prevent crashes
    const ruleLower = (rule === null || rule === void 0 ? void 0 : rule.toLowerCase()) || '';
    const messageLower = (message === null || message === void 0 ? void 0 : message.toLowerCase()) || '';
    const toolLower = (tool === null || tool === void 0 ? void 0 : tool.toLowerCase()) || '';
    // ================================================================
    ...
    if (ruleLower.includes('security') ||
    ...
    if (ruleLower.includes('dependency') ||
    ...
    if (ruleLower.includes('r0') || // Pylint: refactoring recommendations
    ...
    if (ruleLower.includes('architecture') ||
 ...
 */
function calculateRiskLevel(category, severity, rule) {
 ...
 */
function getCategoryContext(category, severity) {
    const contexts = {
        'Security': {
 ...
 */
function getPriorityGuidance(category, severity, count, riskLevel) {
