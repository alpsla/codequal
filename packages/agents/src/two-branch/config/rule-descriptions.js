...
exports.RULE_DESCRIPTIONS = void 0;
...
function getUserFriendlyTitle(rule, tool) {
    const desc = exports.RULE_DESCRIPTIONS[rule];
    if (desc) {
        return desc.title;
    }
 ...
 */
function getToolSpecificFixGuidance(rule, tool) {
    const toolGuidance = {
        // Security tools
 ...
 */
function getRuleDescription(rule, tool) {
    // First check for explicit rule description
    if (exports.RULE_DESCRIPTIONS[rule]) {
        return exports.RULE_DESCRIPTIONS[rule];
    }
