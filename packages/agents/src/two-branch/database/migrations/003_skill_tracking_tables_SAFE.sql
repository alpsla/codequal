-- ============================================================================
-- Migration: Add skill tracking and gamification tables (SAFE VERSION)
-- Version: 003
-- Date: 2025-10-03
-- Purpose: Enable developer skill tracking, trend analysis, and gamification
--
-- SAFE VERSION: Drops existing tables first to avoid column conflicts
...
-- Indexes for fast lookups
CREATE INDEX idx_analysis_results_pr
  ON analysis_results(repository, pr_number);

CREATE INDEX idx_analysis_results_author
  ON analysis_results(pr_author, analyzed_at DESC);

CREATE INDEX idx_analysis_results_decision
