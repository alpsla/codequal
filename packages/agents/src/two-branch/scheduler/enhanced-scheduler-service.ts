...
// import { ModelVersionSync } from '../../standard/services/model-version-sync'; // TODO: Fix this import
...
const SystemAuthService = {} as any;
const SYSTEM_USER = { id: 'system', email: 'system@codequal.com' };
...
export class EnhancedSchedulerService {
  ...
  private modelVersionSync: typeof ModelVersionSync;
