...
exports.BasicDeduplicator = void 0;
...
class BasicDeduplicator {
    constructor() {
        this.logger = (0, utils_1.createLogger)('BasicDeduplicator');
        this.exactMatchThreshold = 1.0;
        this.similarityThreshold = 0.7; // Lowered for better matching
    }
    /**
     ...
     */
    removeExactDuplicates(findings) {
        const seen = new Map();
        const unique = [];
        let duplicates = 0;
...
exports.BasicDeduplicator = BasicDeduplicator;
