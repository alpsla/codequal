...
exports.ReportGeneratorV8Fixes = void 0;
const dynamic_model_selector_1 = require("../services/dynamic-model-selector");
const utils_1 = require("@codequal/core/utils");
const logger = (0, utils_1.createLogger)('ReportGeneratorV8Fixes');
class ReportGeneratorV8Fixes {
    constructor() {
     ...
     */
    adjustSeverityForTestFiles(issue) {
     ...
     */
    generateTargetedEducation(issue) {
        const educationMap = {
            'input validation': `
...
- Learn more: Software Craftsmanship`;
     ...
     */
    async getFileStats(repositoryUrl) {
...
exports.ReportGeneratorV8Fixes = ReportGeneratorV8Fixes;
