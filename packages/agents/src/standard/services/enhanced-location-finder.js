...
exports.EnhancedLocationFinder = void 0;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const child_process_1 = require("child_process");
class EnhancedLocationFinder {
    /**
     * Find locations for issues using multiple strategies
     */
    async findLocations(repoPath, issues) {
     ...
     */
    async searchInSpecificFile(repoPath, issue) {
     ...
     */
    async searchBySnippet(repoPath, issue) {
        ...
        for (const line of lines.slice(0, 3)) { // Try top 3 most distinctive lines
            ...
            try {
                ...
                const output = (0, child_process_1.execSync)(cmd, { encoding: 'utf-8', maxBuffer: 1024 * 1024 });
                if (output) {
     ...
     */
    async searchByKeywords(repoPath, issue) {
        const searchTerms = this.extractSearchTerms(issue);
        for (const term of searchTerms) {
            try {
     ...
     */
    async searchByCategoryPatterns(repoPath, issue) {
     ...
     */
    findSimilarFile(repoPath, fileName) {
...
exports.EnhancedLocationFinder = EnhancedLocationFinder;
