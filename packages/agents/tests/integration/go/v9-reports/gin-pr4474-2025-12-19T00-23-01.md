...
**Analysis Date:** December 18, 2025 at 07:22 PM EST  
...
**🎁 Quick Win:** 6 of 6 issues (100%) can be auto-fixed in ~1 minutes with linter `--fix` commands.
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 6 | 21.3s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/gin-pr4474-1766103775188/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/gin-pr4474-1766103775188/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/gin-pr4474-1766103775188/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/gin-pr4474-1766103775188/all-issues-manifest.json)
