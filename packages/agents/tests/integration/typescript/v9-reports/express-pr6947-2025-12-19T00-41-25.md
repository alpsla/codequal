...
**Analysis Date:** December 18, 2025 at 07:41 PM EST  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 50 | 24.3s | FREE |
| Code Quality Agent | N/A | 0 | 2.4s | FREE |
| Dependencies Agent | N/A | 0 | 2.6s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/express-pr6947-1766104873557/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/express-pr6947-1766104873557/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/express-pr6947-1766104873557/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/express-pr6947-1766104873557/all-issues-manifest.json)
