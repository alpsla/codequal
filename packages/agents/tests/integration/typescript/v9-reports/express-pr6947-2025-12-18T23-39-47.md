...
**Analysis Date:** December 18, 2025 at 06:39 PM EST  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 50 | 24.8s | FREE |
| Code Quality Agent | N/A | 0 | 2.2s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/express-pr6947-1766101174873/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/express-pr6947-1766101174873/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/express-pr6947-1766101174873/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/express-pr6947-1766101174873/all-issues-manifest.json)
