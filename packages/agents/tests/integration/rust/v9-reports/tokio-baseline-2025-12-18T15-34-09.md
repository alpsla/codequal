...
**Source Branch:** main  
**Target Branch:** main  
**Analysis Date:** December 18, 2025 at 10:33 AM EST  
**Repository Size:** 3,219 files | 100,884 lines  
...
| Metric | Value |
|--------|-------|
| Total Repository Files | 3,219 |
| Lines of Code | 100,884 |
| Files Modified | 1 |
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 0 | 28.9s | FREE |
| Code Quality Agent | N/A | 1 | 27.1s | FREE |
| Dependencies Agent | N/A | 0 | 0.4s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr0-1766072039016/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr0-1766072039016/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr0-1766072039016/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr0-1766072039016/all-issues-manifest.json)
