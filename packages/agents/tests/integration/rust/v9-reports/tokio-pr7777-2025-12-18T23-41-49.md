...
**Analysis Date:** December 18, 2025 at 06:41 PM EST  
**Repository Size:** 4,547 files | 100,493 lines  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 0 | 36.5s | FREE |
| Code Quality Agent | N/A | 1 | 13.5s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr7777-1766101297948/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr7777-1766101297948/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr7777-1766101297948/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr7777-1766101297948/all-issues-manifest.json)
