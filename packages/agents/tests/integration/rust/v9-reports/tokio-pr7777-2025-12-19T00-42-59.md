...
**Analysis Date:** December 18, 2025 at 07:42 PM EST  
**Repository Size:** 3,687 files | 100,493 lines  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 0 | 32.3s | FREE |
| Code Quality Agent | N/A | 1 | 10.1s | FREE |
| Dependencies Agent | N/A | 0 | 1.4s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr7777-1766104969517/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr7777-1766104969517/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr7777-1766104969517/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/tokio-pr7777-1766104969517/all-issues-manifest.json)
