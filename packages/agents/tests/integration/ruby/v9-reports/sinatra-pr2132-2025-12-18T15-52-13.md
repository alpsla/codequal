...
**Target Branch:** main  
**Analysis Date:** December 18, 2025 at 10:52 AM EST  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 2 | 26.7s | FREE |
| Code Quality Agent | N/A | 0 | 1.8s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr2132-1766073128084/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr2132-1766073128084/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr2132-1766073128084/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr2132-1766073128084/all-issues-manifest.json)
