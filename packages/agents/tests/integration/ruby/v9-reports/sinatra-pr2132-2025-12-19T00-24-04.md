...
**Target Branch:** main  
**Analysis Date:** December 18, 2025 at 07:23 PM EST  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 2 | 26.4s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr2132-1766103838567/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr2132-1766103838567/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr2132-1766103838567/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr2132-1766103838567/all-issues-manifest.json)
