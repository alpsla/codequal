...
**Source Branch:** main  
**Target Branch:** main  
**Analysis Date:** December 18, 2025 at 10:31 AM EST  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 2 | 27.6s | FREE |
| Code Quality Agent | N/A | 0 | 2.9s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr0-1766071875137/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr0-1766071875137/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr0-1766071875137/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/sinatra-pr0-1766071875137/all-issues-manifest.json)
