...
**Target Branch:** 12.x  
**Analysis Date:** December 18, 2025 at 10:53 AM EST  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 1 | 42.5s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/framework-pr58164-1766073221255/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/framework-pr58164-1766073221255/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/framework-pr58164-1766073221255/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/framework-pr58164-1766073221255/all-issues-manifest.json)
