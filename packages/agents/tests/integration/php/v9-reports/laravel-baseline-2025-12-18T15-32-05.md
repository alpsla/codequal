...
**Repository Size:** 3,011 files | 100,751 lines  
...
**Overall Scores**:
- 📱 **APP Score**: 99/100 (MIN of categories - "weakest link")
- 👨‍💻 **Skill Score**: 50/100 (AVG of categories)

> Scores saved to Supabase for tracking trends over time


> 🚀 **Fix Coverage**: 1 issues (100%) have pattern-based fixes available
...
- 📚 **Pattern Fixes**: 1 issues (100.0%) - Pre-learned fixes from 500+ patterns in Supabase
...
SQL query is constructed using string concatenation with user input (Rule: php.lang.security.injection.tainted-filename.tainted-filename), allowing SQL injection attacks.
...
**Location**: `src/Illuminate/Foundation/resources/server.php` (Line 12)
...
AI-generated fix pattern for php.lang.security.injection.tainted-filename.tainted-filename
...
if ($uri !== '/' && file_exists($publicPath.basename($uri))) {
    return false;
}
...
**Recommendation:** Address during regular refactoring cycles or enable pre-commit hooks (PHP-CS-Fixer, PHPStan).
...
|------|-----------|-------|-------------|
| 1 | Neil Carlo Sucuangco | 50/100 | 1 |
...
| Metric | Value |
|--------|-------|
| Total Repository Files | 3,011 |
| Lines of Code | 100,751 |
| Files Modified | 1 |
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 1 | 31.2s | FREE |
| Code Quality Agent | N/A | 0 | 0.0s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/framework-pr0-1766071913438/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/framework-pr0-1766071913438/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/framework-pr0-1766071913438/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/framework-pr0-1766071913438/all-issues-manifest.json)
