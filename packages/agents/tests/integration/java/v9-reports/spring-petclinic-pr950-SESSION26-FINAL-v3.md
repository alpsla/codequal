...
**Target Branch:** main  
**Analysis Date:** December 16, 2025 at 07:48 PM GMT  
...
- 👨‍💻 **Skill Score**: 3/100 (AVG of categories)
...
| ⚡ Performance | 3/100 | 11/100 | ➡️ Average |
| 🏗️  Architecture | 3/100 | 11/100 | ➡️ Average |
| 📦 Dependencies | 3/100 | 11/100 | ➡️ Average |
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 1 | 317.8s | FREE |
| Code Quality Agent | N/A | 328 | 18.4s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic-pr950-1765914535848/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic-pr950-1765914535848/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic-pr950-1765914535848/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic-pr950-1765914535848/all-issues-manifest.json)
