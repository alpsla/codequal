...
**Target Branch:** main  
**Analysis Date:** December 16, 2025 at 06:54 PM GMT  
...
- 👨‍💻 **Skill Score**: 6/100 (AVG of categories)
...
|----------|------------|----------|--------|
| 🔒 Security | 3/100 | 12/100 | ➡️ Average |
| ⚡ Performance | 6/100 | 12/100 | ➡️ Average |
| 🏗️  Architecture | 6/100 | 12/100 | ➡️ Average |
| 📦 Dependencies | 6/100 | 12/100 | ➡️ Average |
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 1 | 317.3s | FREE |
| Code Quality Agent | N/A | 328 | 17.6s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic-pr950-1765911267061/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic-pr950-1765911267061/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic-pr950-1765911267061/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic-pr950-1765911267061/all-issues-manifest.json)
