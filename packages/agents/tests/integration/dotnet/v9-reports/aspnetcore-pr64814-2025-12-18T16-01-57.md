...
**Target Branch:** main  
**Analysis Date:** December 18, 2025 at 11:01 AM EST  
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 68 | 123.7s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/aspnetcore-pr64814-1766073696453/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/aspnetcore-pr64814-1766073696453/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/aspnetcore-pr64814-1766073696453/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/aspnetcore-pr64814-1766073696453/all-issues-manifest.json)
