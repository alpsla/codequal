...
|----------|------------|----------|--------|
| 🔒 Security | 36/100 | 45/100 | ➡️ Average |
| ⚡ Performance | 36/100 | 45/100 | ➡️ Average |
| 🏗️  Architecture | 36/100 | 45/100 | ➡️ Average |
| 📦 Dependencies | 36/100 | 45/100 | ➡️ Average |
...
|-------|-------|--------------|------|------|
| Security Agent | N/A | 0 | 3.4s | FREE |
| Code Quality Agent | N/A | 49 | 1.5s | FREE |
| Dependencies Agent | N/A | 0 | 2.2s | FREE |
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/requests-pr7124-1766101120737/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/requests-pr7124-1766101120737/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/requests-pr7124-1766101120737/codequal-gitlab-codequality.json)
...
📦 **Manifest file** (for AI assistants with lazy loading): [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/requests-pr7124-1766101120737/all-issues-manifest.json)
