...
exports.ThreeTierAnalysisService = exports.TargetedPerspective = exports.AnalysisDepth = void 0;
/**
...
(function (AnalysisDepth) {
    ...
    AnalysisDepth["TARGETED"] = "targeted"; // Targeted architectural deep dive
})(AnalysisDepth || (exports.AnalysisDepth = AnalysisDepth = {}));
/**
 * Targeted analysis perspective types
 */
var TargetedPerspective;
(function (TargetedPerspective) {
    TargetedPerspective["ARCHITECTURE"] = "architecture";
    TargetedPerspective["PATTERNS"] = "patterns";
    TargetedPerspective["PERFORMANCE"] = "performance";
    TargetedPerspective["SECURITY"] = "security";
    TargetedPerspective["TESTING"] = "testing";
    TargetedPerspective["DEPENDENCIES"] = "dependencies";
    TargetedPerspective["MAINTAINABILITY"] = "maintainability";
})(TargetedPerspective || (exports.TargetedPerspective = TargetedPerspective = {}));
/**
 * Targeted perspective query mapping
 */
const PERSPECTIVE_QUERIES = {
    [TargetedPerspective.ARCHITECTURE]: "What is the overall architecture of this repository? Please identify the main components, how they interact with each other, and evaluate the architectural approach used. Include any architectural patterns you identify and assess their appropriateness.",
    [TargetedPerspective.PATTERNS]: "What design patterns and architectural approaches are used in this codebase? Are there any anti-patterns that should be addressed? How consistently are patterns applied across the codebase?",
    [TargetedPerspective.PERFORMANCE]: "What are the potential performance bottlenecks in this codebase? How efficiently are resources managed in critical paths? Are there any optimizations that could improve performance significantly?",
    [TargetedPerspective.SECURITY]: "What security vulnerabilities or potential risks exist in this codebase? Are there any insecure coding practices, dependency vulnerabilities, or areas where security best practices aren't being followed?",
    [TargetedPerspective.TESTING]: "How well is this codebase tested? Evaluate the test coverage, testing approaches used, and identify any gaps in the testing strategy. Are there areas that would benefit from additional testing?",
    [TargetedPerspective.DEPENDENCIES]: "Analyze the dependency management in this codebase. Are dependencies up-to-date, properly managed, and appropriately used? Are there any risks associated with the current dependency strategy?",
    [TargetedPerspective.MAINTAINABILITY]: "How maintainable is this codebase? Evaluate code organization, documentation, complexity, and adherence to coding standards. What refactoring opportunities would improve maintainability?"
};
/**
...
class ThreeTierAnalysisService {
     ...
     */
    async analyzePR(repository, prId, options) {
     ...
     * @returns Analysis result
     */
    async analyzePullRequest(repository, options) {
     ...
     * @returns Analysis result
     */
    async performQuickAnalysis(repository, options) {
     ...
     * @returns Analysis result
     */
    async performComprehensiveAnalysis(repository, options) {
     ...
     * @returns Analysis result
     */
    async performTargetedAnalysis(repository, options) {
     ...
     * @returns Analysis result
     */
    async performQuickPRAnalysis(repository, options) {
     ...
     * @returns Analysis result
     */
    async performComprehensivePRAnalysis(repository, options) {
     ...
     * @returns Analysis result
     */
    async performTargetedPRAnalysis(repository, options) {
...
exports.ThreeTierAnalysisService = ThreeTierAnalysisService;
