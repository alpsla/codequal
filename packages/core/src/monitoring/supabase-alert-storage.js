...
exports.SupabaseAlertStorage = void 0;
...
class SupabaseAlertStorage {
    constructor(supabaseUrl, supabaseKey) {
        ...
        this.logger = (0, logger_1.createLogger)('SupabaseAlertStorage');
     ...
     */
    async getRecentAlerts(service, limit = 100) {
        try {
     ...
     */
    async getAlertMetrics(service, startTime, endTime) {
        try {
            const { data, error } = await this.supabase
                .from('monitoring_alerts')
                .select('*')
