...
**Target Branch:** trunk  
**Analysis Date:** October 24, 2025 at 03:43 PM GMT  
...
> 🚀 **Quick Win**: 481,507 issues (99%) can be automatically fixed using the attached manifest file!
...
**Total Issues**: 487,275 (60 unique types)
...
**By Category**:
- 🆕 NEW: 89873 (introduced in this PR)
- ⚠️  EXISTING_MODIFIED: 382 (pre-existing in modified files)
- ✅ RESOLVED: 768 (fixed by this PR)
- 📝 EXISTING_REST: 396252 (pre-existing in unchanged files)
...
- 📊 **Most Common**: Com Puppycrawl Tools Checkstyle Checks Indentation IndentationCheck appears 347284 times
- 🔒 **Security Alert**: 2 critical security vulnerabilities found
- 🔧 **Auto-Fix Available**: 481507 issues can be fixed automatically (see IDE integration files)
...
🚀 **Quick Win**: Use the attached manifest file to automatically fix 481,507 issues (99%) - saving significant development time!
...
3. **Code Review Process**: High issue count (89873 new) suggests need for more thorough pre-commit review
...
Use a safer method to execute system commands by avoiding shell interpretation. Prefer using the overloaded version of ProcessBuilder that takes a list of command and arguments, or use a library that handles command execution securely.
...
After:
List<String> commands = Arrays.asList("command", "arg1", "arg2");
ProcessBuilder pb = new ProcessBuilder(commands);
```

**Best Practices to Follow**:

- Avoid using shell interpretation in command execution
- Validate and sanitize all inputs used in command execution
- Use higher-level APIs or libraries for command execution when available
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 22593 files | **Category**: EXISTING_REST | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-naming-membernamecheck-medium-checkstyle-cursor-fix.json)
...
Rename the member variable to follow the naming convention, using a descriptive and lowercase name with words separated by underscores.

**Recommended Code**:

```java
Before: int maxWaitTime;
After: int max_wait_time;
```
...
- Use lowercase with underscores for member variable names

#### 📎 All Occurrences

This issue appears in **22593 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 22593 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: PMD | **Found in**: 5581 files | **Category**: NEW
...
Replace the raw Exception type with a more specific checked or unchecked exception type, depending on the context. This allows for better error handling and clarity.

**Recommended Code**:

```java
Before: throw new Exception("Invalid configuration");
After: throw new IllegalArgumentException("Invalid configuration: missing required parameter");
```

**Best Practices to Follow**:

- Use specific exception types for clarity and better error handling
- Avoid using raw Exception types in application code
- Provide meaningful error messages for debugging and logging

#### 📎 All Occurrences

This issue appears in **5581 files** across your codebase.
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 4978 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-whitespace-operatorwrapcheck-medium-checkstyle-cursor-fix.json)
...
Refactor the code to ensure that operators are wrapped correctly according to the OperatorWrapCheck rule. Typically, the operator should be at the end of the line.
...
- Enhanced readability through alignment
- Adherence to coding standards

#### 📎 All Occurrences

This issue appears in **4978 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 4978 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 4138 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-missingjavadocmethodcheck-medium-checkstyle-cursor-fix.json)
...
After:
/**
 * Constructs a ConsumerGroupDescription with the given group ID and other parameters.
 *
...
- Include parameter descriptions, return value explanations, and thrown exceptions in Javadoc
- Keep Javadoc concise and focused on what the method does, not how it does it

#### 📎 All Occurrences

This issue appears in **4138 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 4138 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 3124 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-javadocparagraphcheck-medium-checkstyle-cursor-fix.json)
...
Ensure that Javadoc comments are properly formatted with paragraphs separated by a blank line.
...
Before:
/**
 * This method updates the configuration for a given resource.
 * It takes an AlterConfigOpType which specifies the operation to perform.
 * The configKey and configValue are used to identify and set the configuration.
 */
...
- Use blank lines to separate paragraphs in Javadoc comments
- Ensure Javadoc is clear and concise
- Maintain consistent formatting for better readability

#### 📎 All Occurrences

This issue appears in **3124 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 3124 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 2878 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-missingjavadoctypecheck-medium-checkstyle-cursor-fix.json)
...
Add Javadoc comment to the class to describe its purpose and functionality.
...
/**
 * Represents an operation to alter configuration settings.
...
- Document classes with Javadoc to improve code readability and maintainability
- Use Javadoc to explain the purpose and usage of classes
- Follow JavaDoc conventions for consistency

#### 📎 All Occurrences

This issue appears in **2878 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 2878 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 1875 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-summaryjavadoccheck-medium-checkstyle-cursor-fix.json)
...
Add a summary Javadoc comment to the class or method to provide a brief description of its purpose and functionality.
 ...
 * This class provides methods to retrieve the status and details of the SCRAM credentials for specified users.
 */
public class DescribeUserScramCredentialsResult {
    // class implementation
}
...
- Use Javadoc comments to document the purpose and functionality of classes and methods
- Provide clear and concise summary comments for better code readability and maintainability
- Consistently apply Javadoc standards across the codebase

#### 📎 All Occurrences

This issue appears in **1875 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 1875 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 1391 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-coding-multiplevariabledeclarationscheck-medium-checkstyle-cursor-fix.json)
...
Separate variable declarations onto individual lines for better readability and maintainability.
...
This issue appears in **1391 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 1391 occurrences with one click!
...
```java
Before:
System.out.println("Connection failed for node " + node.id() + ": " + e);

After:
private static final Logger logger = LoggerFactory.getLogger(NetworkClient.class);
logger.error("Connection failed for node {}: {}", node.id(), e.getMessage(), e);
```
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 1024 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-requireemptylinebeforeblocktaggroupcheck-medium-checkstyle-cursor-fix.json)
...
Ensure there is an empty line before each block tag group in the Javadoc comment.
...
- Use empty lines to separate block tags in Javadoc for better readability
- Maintain consistent formatting in Javadoc comments
- Ensure Javadoc is clear and concise

#### 📎 All Occurrences

This issue appears in **1024 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 1024 occurrences with one click!
...
Refactor the line to ensure that the dot is placed at the end of the previous line or the beginning of the next line, adhering to the SeparatorWrapDot rule.
...
- Readability of method chaining
...
**Severity**: MEDIUM | **Tool**: PMD | **Found in**: 597 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-avoidusingvolatile-medium-pmd-cursor-fix.json)
...
Replace the volatile keyword with an appropriate concurrency control mechanism such as AtomicReference or synchronized blocks to ensure thread safety without the potential pitfalls of volatile.
...
- Use Atomic classes for simple atomic operations
- Prefer synchronized blocks for more complex operations
- Avoid volatile for complex state management

#### 📎 All Occurrences

This issue appears in **597 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 597 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 485 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-coding-variabledeclarationusagedistancecheck-medium-checkstyle-cursor-fix.json)
...
This issue appears in **485 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 485 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 276 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-coding-overloadmethodsdeclarationordercheck-medium-checkstyle-cursor-fix.json)
...
This issue appears in **276 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 276 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 246 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-naming-abbreviationaswordinnamecheck-medium-checkstyle-cursor-fix.json)
...
This issue appears in **246 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 246 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 172 files | **Category**: EXISTING_REST | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-naming-packagenamecheck-medium-checkstyle-cursor-fix.json)
...
**Location**: `jmh-benchmarks/build/generated/sources/annotationProcessor/java/main/org/apache/kafka/jmh/common/jmh_generated/ImplicitLinkedHashCollectionBenchmark_jmhType_B1.java` (Line 1)

**Code**:

```java
>    1 | package org.apache.kafka.jmh.common.jmh_generated;
     2 | import org.apache.kafka.jmh.common.ImplicitLinkedHashCollectionBenchmark;
     3 | public class ImplicitLinkedHashCollectionBenchmark_jmhType_B1 extends org.apache.kafka.jmh.common.ImplicitLinkedHashCollectionBenchmark {
...
This issue appears in **172 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 172 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 120 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-nonemptyatclausedescriptioncheck-medium-checkstyle-cursor-fix.json)
...
This issue appears in **120 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 120 occurrences with one click!
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 97 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-atclauseordercheck-medium-checkstyle-cursor-fix.json)
...
**Severity**: MEDIUM | **Tool**: checkstyle | **Found in**: 37 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-singlelinejavadoccheck-medium-checkstyle-cursor-fix.json)
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 347284 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-indentation-indentationcheck-low-checkstyle-cursor-fix.json)
...
Adjust the indentation to align with the code style conventions by ensuring that the code block is indented consistently with the surrounding code. Use an editor or IDE that supports auto-formatting to maintain alignment.
...
- Use of auto-formatting tools
- Follow project-specific code style guidelines

#### 📎 All Occurrences

This issue appears in **347284 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 347284 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 40793 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-sizes-linelengthcheck-low-checkstyle-cursor-fix.json)
...
Break the long line into multiple lines for better readability and ensure it adheres to the line length limit defined by the project's style guide.

**Recommended Code**:

```java
before: // Long line exceeding the limit
after: // Split the line into multiple lines for better readability
     // and ensure it adheres to the line length limit.
```

**Best Practices to Follow**:

- Adhere to a consistent line length limit (e.g., 80 or 120 characters).
- Use line breaks to improve code readability for long lines.
- Follow the project's code style guide for formatting.

#### 📎 All Occurrences

This issue appears in **40793 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 40793 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 13521 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-imports-customimportordercheck-low-checkstyle-cursor-fix.json)
...
Reorder the import statements to follow a consistent and logical order, typically grouping them by standard, third-party, and project-specific imports, and then sorting alphabetically within each group.
...
This issue appears in **13521 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 13521 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 11187 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-naming-localvariablenamecheck-low-checkstyle-cursor-fix.json)
...
Rename the local variable to follow the naming convention, typically camelCase starting with a lowercase letter.

**Recommended Code**:

```java
Before: int V;
After: int variableValue;
```

**Best Practices to Follow**:

- useCamelCaseForVariableNames
- avoidSingleLetterVariableNames
- makeVariableNamesDescriptive

#### 📎 All Occurrences

This issue appears in **11187 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 11187 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 9652 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-naming-parameternamecheck-low-checkstyle-cursor-fix.json)
...
Rename the parameter to follow naming conventions, typically camelCase starting with a lowercase letter.

**Recommended Code**:

```java
Before: public void reportMetric(String METRIC_NAME) {
    // method body
}

After: public void reportMetric(String metricName) {
    // method body
}
```
...
- followNamingConventions
- improveCodeReadability

#### 📎 All Occurrences

This issue appears in **9652 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 9652 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 7256 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-blocks-needbracescheck-low-checkstyle-cursor-fix.json)
...
Add braces to the if statement to improve readability and maintainability.
...
if (configEntry.value() == null)
    throw new IllegalArgumentException("Config entry value cannot be null");
...
This issue appears in **7256 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 7256 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 3536 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-whitespace-emptylineseparatorcheck-low-checkstyle-cursor-fix.json)
...
Add an empty line separator between the previous code block and the next code block to improve readability.
...
- Use empty lines to separate methods for better readability
- Maintain consistent spacing for code blocks
- Follow the coding style guide for the project

#### 📎 All Occurrences

This issue appears in **3536 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 3536 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 438 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-javadoc-javadoctagcontinuationindentationcheck-low-checkstyle-cursor-fix.json)
...
This issue appears in **438 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 438 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 258 files | **Category**: EXISTING_REST | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-modifier-modifierordercheck-low-checkstyle-cursor-fix.json)
...
**Location**: `jmh-benchmarks/build/generated/sources/annotationProcessor/java/main/org/apache/kafka/jmh/common/jmh_generated/ImplicitLinkedHashCollectionBenchmark_jmhType_B2.java` (Line 6)

**Code**:

```java
     3 | public class ImplicitLinkedHashCollectionBenchmark_jmhType_B2 extends ImplicitLinkedHashCollectionBenchmark_jmhType_B1 {
     4 |     public volatile int setupTrialMutex;
     5 |     public volatile int tearTrialMutex;
>    6 |     public final static AtomicIntegerFieldUpdater<ImplicitLinkedHashCollectionBenchmark_jmhType_B2> setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(ImplicitLinkedHashCollectionBenchmark_...
     7 |     public final static AtomicIntegerFieldUpdater<ImplicitLinkedHashCollectionBenchmark_jmhType_B2> tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(ImplicitLinkedHashCollectionBenchmark_j...
     8 | 
...
This issue appears in **258 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 258 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 253 files | **Category**: EXISTING_REST | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-imports-avoidstarimportcheck-low-checkstyle-cursor-fix.json)
...
**Location**: `clients/build/generated/main/java/org/apache/kafka/common/message/EndQuorumEpochRequestDataJsonConverter.java` (Line 34)
...
```java
    ...
    33 | 
>   34 | import static org.apache.kafka.common.message.EndQuorumEpochRequestData.*;
    35 | 
    36 | public class EndQuorumEpochRequestDataJsonConverter {
    37 |     public static EndQuorumEpochRequestData read(JsonNode _node, short _version) {
```
...
This issue appears in **253 files** across your codebase.
...
> 💡 **Tip**: Download the IDE fix file to resolve all 253 occurrences with one click!
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 172 files | **Category**: EXISTING_REST | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-naming-typenamecheck-low-checkstyle-cursor-fix.json)
...
**Location**: `jmh-benchmarks/build/generated/sources/annotationProcessor/java/main/org/apache/kafka/jmh/common/jmh_generated/ImplicitLinkedHashCollectionBenchmark_jmhType_B1.java` (Line 3)
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 105 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-whitespace-whitespacearoundcheck-low-checkstyle-cursor-fix.json)
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 33 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-naming-methodtypeparameternamecheck-low-checkstyle-cursor-fix.json)
...
**Location**: `streams/src/main/java/org/apache/kafka/streams/state/internals/CachingKeyValueStore.java` (Line 422)

**Code**:

```java
   419 |         final KeyValueIterator<Bytes, byte[]> storeIterator = wrapped().all();
   420 |         final ThreadCache.MemoryLRUCacheBytesIterator cacheIterator = internalContext.cache().all(cacheName);
   421 |         return new MergedSortedCacheKeyValueBytesStoreIterator(cacheIterator, storeIterator, true);
>  422 |     }
   423 | 
   424 |     @Override
   425 |     public <PS extends Serializer<P>, P> KeyValueIterator<Bytes, byte[]> prefixScan(final P prefix, final PS prefixKeySerializer) {
```
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 13 files | **Category**: NEW | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-naming-classtypeparameternamecheck-low-checkstyle-cursor-fix.json)
...
**Location**: `streams/src/main/java/org/apache/kafka/streams/state/internals/AbstractMergedSortedCacheStoreIterator.java` (Line 31)

**Code**:

```java
    28 |  * and store entries.
    29 |  *
    30 |  * <p>This iterator is used for state stores in Kafka Streams, which have an (optional) caching layer that needs to be
>   31 |  * "merged" with the underlying state. It handles common scenarios like skipping records with cached tombstones (deleted
    32 |  * entries) and preferring cache entries over store entries when conflicts arise.</p>
    33 |  *
    34 |  * @param <K>  The type of the resulting merged key.
```
...
**Severity**: LOW | **Tool**: checkstyle | **Found in**: 13 files | **Category**: EXISTING_REST | **Auto-fix**: ✅ [Available](attachments/group-com-puppycrawl-tools-checkstyle-checks-blocks-emptyblockcheck-low-checkstyle-cursor-fix.json)
...
**Location**: `clients/build/generated/main/java/org/apache/kafka/common/message/FetchRequestData.java` (Line 542)
...
```java
   539 |         }
   540 |         if (_version <= 14) {
   541 |             _size.addBytes(4);
>  542 |         }
   543 |         if (_version >= 15) {
   544 |             {
   545 |                 if (!this.replicaState.equals(new ReplicaState())) {
```
...
**Good news! All 479,062 CheckStyle issues can be fixed automatically!**
...
-- **Future Risk:** 🟡 Medium
  - Technical debt will compound if 487264 backlog issues are not addressed
...
| **Code Quality** | 0 | 485967 | 485967 | 🟡 Medium |
...
3. **Planning:** Schedule time for 52556 medium-severity issues in upcoming sprints
4. **Continuous Improvement:** Track and reduce 434708 low-severity issues over time
...
🥇 **checkstyle**: 544067 issues in 117.5s (4631.86/s) ⚡ Fast
🥈 **pmd**: 8606 issues in 80.7s (106.67/s) ⚡ Fast
🥉 **spotbugs**: 117 issues in 410.2s (0.29/s) ⚠️ Slow
4. **semgrep**: 11 issues in 113.3s (0.10/s) 🐌 Very Slow
5. **dependency-check**: 0 issues in 37.9s (0.00/s) 🐌 Very Slow
...
### Summary
- **Total Issues:** 487275 (60 unique types)
- **Blocking Issues:** 4 ⛔
- **Resolved Issues:** 768 🎉
- **Analysis Time:** 1110.0s
...
### 💡 Quick Stats
- Auto-fixable: 481507/487275 issues (48/60 types)
- Critical: 2
- High: 9
- Medium: 52556
- Low: 434708
...
- 🟡 Medium: 52556 (lazy loaded after high)
- 🟢 Low: 434708 (lazy loaded after medium)
...
🤖 IDE: [Creates structured todo list]
        ...
        ⏳ Medium issues (52,556) - Waiting...
        ⏳ Low issues (434,708) - Waiting...
