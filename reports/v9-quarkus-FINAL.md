...
**Fix Strategy**:
1. Review [PMD documentation](https://pmd.github.io/latest/pmd_rules_java.html) for rule: `SystemPrintln`
...
**Location**: `kafka-streams-quickstart/aggregator/src/main/java/org/acme/kafka/streams/aggregator/streams/GetWeatherStationDataResult.java` (Line 8)

**Code**:

```java
     5 | 
     6 | import org.acme.kafka.streams.aggregator.model.WeatherStationData;
     7 | 
>    8 | public class GetWeatherStationDataResult {
     9 | 
    10 |     private static GetWeatherStationDataResult NOT_FOUND = new GetWeatherStationDataResult(null, null, null);
    11 | 
```
