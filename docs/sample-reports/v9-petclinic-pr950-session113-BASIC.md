...
**Target Branch:** main  
**Analysis Date:** January 20, 2026 at 09:58 PM EST (1m 34s)
...
|-----------|-------|-------------|
| 📚 **Pattern Fixes** | 2 (0.6%) | Pre-learned fixes from 606+ patterns |
| 💡 **IDE Integration** | ✅ | Export to VS Code, JetBrains |
| 📖 **Guidance** | 328 | Step-by-step instructions |

> 💡 **Upgrade to PRO** for AI-generated fixes on all 330 issues with automatic verification.
...
- **AI Code Suggestions**: AI has generated copy-paste ready fix code for ALL 331 issues (100%)
...
|------|--------------|----------|--------|
| checkstyle | 327 | 3.0s | 🔍 Found |
| semgrep | 2 | 21.7s | 🔍 Found |
| pmd | 1 | 2.5s | 🔍 Found |
| checkov | 0 | 13.5s | ✅ Clean |
| spotbugs | 0 | 10.5s | ✅ Clean |
| grype | 0 | 3.8s | ✅ Clean |
| trivy | 0 | 2.4s | ✅ Clean |
| dependency-check | 0 | 1.2s | ✅ Clean |
| gitleaks | 0 | 0.5s | ✅ Clean |
| jdepend | 0 | 0.3s | ✅ Clean |
| spectral | 0 | 0.0s | ✅ Clean |
| graphql-cop | 0 | 0.0s | ✅ Clean |

### System Information
- **Analyzer Version:** 9.0.0
- **Analysis Date:** 1/20/2026, 9:58:01 PM
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic.git-pr950-1768964281993/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic.git-pr950-1768964281993/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic.git-pr950-1768964281993/codequal-gitlab-codequality.json)
...
📦 **Manifest file**: [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic.git-pr950-1768964281993/all-issues-manifest.json)
