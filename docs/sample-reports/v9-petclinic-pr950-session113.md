...
**Target Branch:** main  
**Analysis Date:** January 21, 2026 at 09:48 PM EST (1m 42s)
...
|------|--------------|----------|--------|
| checkstyle | 327 | 2.6s | 🔍 Found |
| semgrep | 2 | 23.8s | 🔍 Found |
| jdepend | 2 | 0.1s | 🔍 Found |
| pmd | 1 | 2.5s | 🔍 Found |
| checkov | 0 | 7.6s | ✅ Clean |
| spotbugs | 0 | 4.8s | ✅ Clean |
| trivy | 0 | 1.7s | ✅ Clean |
| grype | 0 | 1.5s | ✅ Clean |
...
### System Information
- **Analyzer Version:** 9.0.0
- **Analysis Date:** 1/21/2026, 9:48:20 PM
...
- URL: [Download LSP file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic.git-pr950-1769050100396/codequal-lsp-actions.json)
...
- URL: [Download SARIF file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic.git-pr950-1769050100396/codequal-sarif-report.json)
...
- URL: [Download Code Climate file](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic.git-pr950-1769050100396/codequal-gitlab-codequality.json)
...
📦 **Manifest file**: [all-issues-manifest.json](https://ftjhmbbcuqjqmmbaymqb.supabase.co/storage/v1/object/public/v9-attachments/spring-petclinic.git-pr950-1769050100396/all-issues-manifest.json)
