...
exports.generateEnhancedMockAnalysis = generateEnhancedMockAnalysis;
const utils_1 = require("@codequal/core/utils");
const logger = (0, utils_1.createLogger)('deepwiki-mock-enhanced');
function generateEnhancedMockAnalysis(repositoryUrl) {
